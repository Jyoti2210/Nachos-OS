...
class Thread {
  ...
  public:
    ...
    int GetPid();
    char* GetName();
    MessageBuffer* FetchThreadBuffer(int bufferID, char* sender);
    static Thread* get_thread_id(int pid);
    static Thread* GetThreadByName(char* thread_name);
    // static List<Thread*> *allThreads;
    static bool IsProcessExist(int pid);
  ...
  private:
    ...
    map<int, MessageBuffer*> *threadMessageQueue;
...
// while executing kernel code.
  ...
  public:
    ...
    map<int, MessageBuffer*>* GetThreadMessageQueue();
    int GetMessageCount();
};
