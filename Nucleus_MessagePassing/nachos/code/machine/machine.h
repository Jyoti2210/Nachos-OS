...
// Routines callable by the Nachos kernel
    ...
    void UpdatePagetable(TranslationEntry *pageTableEntry,int newPhyPage);
	void ReadSwapSpace(int swapLoc, int phyPage);
	void WriteIntoSwapSpace(int swapLoc, int phyPage);
	void CleanMainMemory(int pid);
	char* fetchInputFromPointer(int startingAddress);
	void writeMessageInMemory(char* bufferMessage, int ptr);
