...
Kernel::Initialize()
{
    ...
    currentProcess = new Process("main", 5, NULL); //1 is priority	which needs to be generated randomly
    currentProcess->setStatus(RUNNING_PROCESS);
...
void
Kernel::ProcessSelfTest() {
   Semaphore *semaphore;
   SynchList<int> *synchList;
   
   LibSelfTest();		// test library routines
   currentProcess->SelfTest();	// test thread switching
